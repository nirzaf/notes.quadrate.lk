...
import type { ListResourcesResult, RequestId } from '@modelcontextprotocol/sdk/types.js';
...
export function registerNotesResources(server: McpServer, client: ResourceQNotesClient): void {
  ...
  server.registerResource('notes', new ResourceTemplate('qnotes://notes/{noteId}', { list: async (extra) => {
