...
select is((select count(*)::integer from notesdb.search_documents where note_id = '33333333-3333-4333-8333-333333333333' and source_type <> 'note_metadata'), 1, 'empty document payloads retain one searchable note-body document');
