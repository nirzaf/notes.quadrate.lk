...
select public.qnotes_vault_create_secret((select id from auth.users where email = 'owner@qnotes.local'), 'a2000000-0000-4000-8000-000000000001', 'a2000000-0000-4000-8000-000000000002', 'BATCH_LARGE_01', null, repeat('a', 65536), 'a2000000-0000-4000-8000-000000000031', repeat('4', 64), null, 'a2000000-0000-4000-8000-000000000032', 'user_jwt') as response
union all select public.qnotes_vault_create_secret((select id from auth.users where email = 'owner@qnotes.local'), 'a2000000-0000-4000-8000-000000000001', 'a2000000-0000-4000-8000-000000000002', 'BATCH_LARGE_02', null, repeat('b', 65536), 'a2000000-0000-4000-8000-000000000033', repeat('5', 64), null, 'a2000000-0000-4000-8000-000000000034', 'user_jwt')
union all select public.qnotes_vault_create_secret((select id from auth.users where email = 'owner@qnotes.local'), 'a2000000-0000-4000-8000-000000000001', 'a2000000-0000-4000-8000-000000000002', 'BATCH_LARGE_03', null, repeat('c', 65536), 'a2000000-0000-4000-8000-000000000035', repeat('6', 64), null, 'a2000000-0000-4000-8000-000000000036', 'user_jwt')
union all select public.qnotes_vault_create_secret((select id from auth.users where email = 'owner@qnotes.local'), 'a2000000-0000-4000-8000-000000000001', 'a2000000-0000-4000-8000-000000000002', 'BATCH_LARGE_04', null, repeat('d', 65536), 'a2000000-0000-4000-8000-000000000037', repeat('7', 64), null, 'a2000000-0000-4000-8000-000000000038', 'user_jwt')
union all select public.qnotes_vault_create_secret((select id from auth.users where email = 'owner@qnotes.local'), 'a2000000-0000-4000-8000-000000000001', 'a2000000-0000-4000-8000-000000000002', 'BATCH_LARGE_05', null, repeat('e', 65536), 'a2000000-0000-4000-8000-000000000039', repeat('8', 64), null, 'a2000000-0000-4000-8000-000000000040', 'user_jwt');
