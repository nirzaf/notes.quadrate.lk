...
export function ConflictResolver({ open, baseMarkdown, localMarkdown, remoteNote, error, onUseMine, onUseRemote, onSaveMerged, onSaveAsNew, onCancel, remoteDeleted = false }: ConflictResolverProps): JSX.Element {
