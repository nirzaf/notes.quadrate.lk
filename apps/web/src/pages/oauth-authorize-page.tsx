...
export function OAuthAuthorizePage(): JSX.Element {
  ...
  if (missing.length > 0 || invalidPkce) {
    return <main className="q-auth-page"><section className="q-card q-auth-card" role="alert"><p className="q-eyebrow">QNotes</p><h1 className="q-display" style={{ fontSize: '2.8rem' }}>This connection request is incomplete.</h1><p className="q-subtitle">Return to Gemini Spark and start the connection again. No token was requested or stored.</p></section></main>;
  }
