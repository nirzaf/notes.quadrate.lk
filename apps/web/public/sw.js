...
const OFFLINE_DOCUMENT = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>QNotes offline</title><style>body{font-family:system-ui,sans-serif;max-width:42rem;margin:15vh auto;padding:1.5rem;color:#1d252c;background:#f7f4ee}main{background:white;border:1px solid #d8d0c2;border-radius:1rem;padding:2rem}h1{margin-top:0}</style></head><body><main><p>QNotes</p><h1>You are offline</h1><p>The workspace could not be loaded. Reconnect and try again. Local drafts in this browser are left untouched.</p></main></body></html>`;
